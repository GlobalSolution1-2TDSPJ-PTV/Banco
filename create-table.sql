-- DROP TABLES NA ORDEM CERTA PARA EVITAR VIOLAÇÃO DE CHAVES ESTRANGEIRAS
DROP TABLE leituras_sensor CASCADE CONSTRAINTS;
DROP TABLE alertas CASCADE CONSTRAINTS;
DROP TABLE sos CASCADE CONSTRAINTS;
